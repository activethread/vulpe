...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="container">
			...
			<c:if test="${global['project-view-useBackendLayer']}"><div id="backend"></c:if>
			<div id="header">
				<%@include file="/WEB-INF/protected-jsp/commons/header.jsp" %>
			</div>
			<div id="menu">
				<ul id="nav" class="${global['project-view-backendMenuType'] == 'SUPERFISH'?'sf-menu':''}">
					<%@include file="/WEB-INF/protected-jsp/commons/menu.jsp" %>
					<c:if test="${global['project-audit']}">
						<%@include file="/WEB-INF/protected-jsp/commons/audit/menu.jsp" %>
					</c:if>
					<c:if test="${global['project-security']}">
			...
			<c:if test="${global['project-view-useBackendLayer']}"></div></c:if>
			<div id="footer">
