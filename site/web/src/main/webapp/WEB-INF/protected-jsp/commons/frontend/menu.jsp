...
<li><a id="menuLearn" href="javascript:void(0);"
	onclick="vulpe.view.request.submitMenu('/frontend/Learn/ajax.action');"
...
<li><a id="menuCommunity" href="javascript:void(0);"
	onclick="vulpe.view.request.submitMenu('/frontend/Community/ajax.action');"
...
<li><a id="menuCode" href="javascript:void(0);"
	onclick="vulpe.view.request.submitMenu('/frontend/Code/ajax.action');"
...
<li><a id="menuModules" href="javascript:void(0);"
	onclick="vulpe.view.request.submitMenu('/frontend/Modules/ajax.action');"
