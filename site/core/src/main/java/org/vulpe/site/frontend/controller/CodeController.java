...
@Component("frontend.CodeController")
@Controller(controllerType = ControllerType.FRONTEND)
public class CodeController extends AbstractVulpeStrutsSimpleController {

	Logger log = Logger.getLogger(CodeController.class);
