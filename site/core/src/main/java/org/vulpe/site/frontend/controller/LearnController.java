...
@Component("frontend.LearnController")
@Controller(controllerType = ControllerType.FRONTEND)
public class LearnController extends AbstractVulpeStrutsSimpleController {

	Logger log = Logger.getLogger(LearnController.class);
