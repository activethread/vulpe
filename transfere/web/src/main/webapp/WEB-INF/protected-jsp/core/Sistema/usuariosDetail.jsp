...
<v:table>
	<jsp:attribute name="tableBody">
		<v:row>
			<v:column labelKey="label.transfere.core.Sistema.crud.usuarios.usuario">
			...
			<v:column labelKey="label.transfere.core.Sistema.crud.usuarios.publicaProducao">
				<v:checkbox property="publicaProducao"
					fieldValue="true"
				/>
			</v:column>
			<v:column labelKey="label.transfere.core.Sistema.crud.usuarios.administrador">
