 ...
 */
@Component("anuncios.EscolaMinisterioSelect")
@SuppressWarnings("serial")
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
@Controller(controllerType = ControllerType.SELECT, serviceClass = AnunciosServices.class)
public class EscolaMinisterioSelectController extends ApplicationBaseController<EscolaMinisterio, java.lang.Long> {
