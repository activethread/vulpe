...
@CodeGenerator(controller = {
		@Controller(controllerType = ControllerType.CRUD, detailsConfig = { @DetailConfig(name = "discursos", propertyName = "entity.discursos", despiseFields = "tema", cardinalityType = CardinalityType.ONE_OR_MORE, newDetails = 3) }),
		@Controller(controllerType = ControllerType.SELECT) }, manager = true, view = @View(viewType = {
		ViewType.SELECT, ViewType.CRUD }))
@SuppressWarnings("serial")
public class ReuniaoServico extends AbstractVulpeBaseEntityImpl<Long> {
