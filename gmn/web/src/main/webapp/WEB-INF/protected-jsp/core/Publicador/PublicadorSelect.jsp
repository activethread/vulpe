...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<td><v:text labelKey="label.gmn.core.Publicador.select.nome" property="nome" size="40"
			maxlength="60" /></td>
	...
	<tr>
		<td><v:select labelKey="label.gmn.core.Publicador.select.cargo" property="cargo"
			showBlank="true" autoLoad="false" /></td>
		<td colspan="2"><v:checkboxlist labelKey="label.gmn.core.Publicador.select.privilegiosAdicionais" property="privilegiosAdicionais" enumeration="PrivilegioAdicional" /></td>
	</tr>
</table>