...
<%@ attribute name="detailConfig" required="false" rtexprvalue="true" type="org.vulpe.controller.struts.common.BaseDetailConfig" %>
...
<c:if test="${exibe eq true}">
	...
	<c:if test="${not empty items && fn:length(items) > 0}">
		...
		<c:if test="${not empty pagingList}">
			<div class="paging">
				<v:action widthIcon="16" heightIcon="16" iconClass="${(empty pagingList.firstPage ? 'off' : '')}" icon="${pageContext.request.contextPath}/themes/${vulpeTheme}/images/button-go-first.png" labelKey="vulpe.label.first" javascript="vulpe.view.request.submitPaging(${empty pagingList.firstPage ? 0 : pagingList.firstPage}, '${pagingActionName}', '${pagingFormName}', '${pagingLayerFields}', '${pagingLayer}', '${not empty pagingList.firstPage ? pagingBeforeJs : 'false'}', '${pagingAfterJs}');"/>
				<v:action widthIcon="16" heightIcon="16" iconClass="${(empty pagingList.previousPage ? 'off' : '')}" icon="${pageContext.request.contextPath}/themes/${vulpeTheme}/images/button-go-previous.png" labelKey="vulpe.label.previous" javascript="vulpe.view.request.submitPaging(${empty pagingList.previousPage ? 0 : pagingList.previousPage}, '${pagingActionName}', '${pagingFormName}', '${pagingLayerFields}', '${pagingLayer}', '${not empty pagingList.previousPage ? pagingBeforeJs : 'false'}', '${pagingAfterJs}');"/>
				<fmt:message key="vulpe.label.page"/>&nbsp;${pagingList.page}&nbsp;<fmt:message key="vulpe.label.of"/>&nbsp;${pagingList.pages}
				<v:action widthIcon="16" heightIcon="16" iconClass="${(empty pagingList.nextPage ? 'off' : '')}" icon="${pageContext.request.contextPath}/themes/${vulpeTheme}/images/button-go-next.png" labelKey="vulpe.label.next" javascript="vulpe.view.request.submitPaging(${empty pagingList.nextPage ? 0 : pagingList.nextPage}, '${pagingActionName}', '${pagingFormName}', '${pagingLayerFields}', '${pagingLayer}', '${not empty pagingList.nextPage ? pagingBeforeJs : 'false'}', '${pagingAfterJs}');"/>
				<v:action widthIcon="16" heightIcon="16" iconClass="${(empty pagingList.lastPage ? 'off' : '')}" icon="${pageContext.request.contextPath}/themes/${vulpeTheme}/images/button-go-last.png" labelKey="vulpe.label.last" javascript="vulpe.view.request.submitPaging(${empty pagingList.lastPage ? 0 : pagingList.lastPage}, '${pagingActionName}', '${pagingFormName}', '${pagingLayerFields}', '${pagingLayer}', '${not empty pagingList.lastPage ? pagingBeforeJs : 'false'}', '${pagingAfterJs}');"/>
			</div>
		</c:if>
	</c:if>
