...
@Transactional
public class UserAuthenticationDAOJPAImpl extends VulpeBaseCRUDDAOJPAImpl<User, Long> implements
		UserAuthenticationDAO {
	protected static final Logger LOG = Logger.getLogger(UserAuthenticationDAOJPAImpl.class);
	 ...
	 */
	public AuthenticationResponse authenticateUser(final String username, final String password)
		...
		return new AuthenticationResponse(VulpeSecurityConstants.AUTHENTICATION_SUCCESS, user);
	}
