 ...
 * @since 1.0
 */
@WebFilter(filterName = "vulpe", urlPatterns = "/*", dispatcherTypes = { DispatcherType.REQUEST, DispatcherType.FORWARD })
public class VulpeFilter extends CharacterEncodingFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
		...
		final String encoding = VulpeConfigHelper.getApplicationConfiguration().characterEncoding();
