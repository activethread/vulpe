...
<title><fmt:message key="vulpe.error.503.title" /></title>
...
<body>
<!--IS_EXCEPTION-->
<div id="messageTitle" style="display: none"><fmt:message key="vulpe.error.503.title" /></div>
<div id="error">
	<h1><fmt:message key="vulpe.error.503.subtitle" /></h1>
	<h2><fmt:message key="vulpe.error.503" /></h2>
	<br>
	<div id="home">
