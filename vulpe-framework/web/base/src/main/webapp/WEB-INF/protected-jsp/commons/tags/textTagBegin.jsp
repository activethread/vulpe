	...
	<c:choose>
		<c:when test="${maskUpper eq 'M' || maskUpper eq 'MONEY' || maskUpper eq 'C' || maskUpper eq 'CURRENCY'}">
			<script type="text/javascript">
				jQuery(function($) {
					vulpe.util.get('${elementId}').maskMoney({
						symbol : "${global['application-view-currencySymbol']}",
						decimal : ",",
						thousands : ".",
						symbolStay : ${global['application-view-stayCurrencySymbol']},
						showSymbol : ${global['application-view-showCurrencySymbol']}
					});
				});
			</script>
